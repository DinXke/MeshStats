...
| `test_alerts.py` | 42 | `alerts`, het `alert`-topic, de acked-flow | Telemetrie is polling, een alarm is een trap: het onderwerp tegenover de doorgever, herhalingen, een klok uit 2024, en waarom niets een alarm verwijdert |
